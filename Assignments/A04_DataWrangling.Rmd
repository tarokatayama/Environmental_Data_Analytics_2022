...
EPAair2018<- read.csv("./Data/Raw/EPAair_O3_NC2018_raw.csv")
EPAair2019<- read.csv("./Data/Raw/EPAair_O3_NC2019_raw.csv")
...
#4
EPAair2018.selected<- select(EPAair2018, Date, DAILY_AQI_VALUE, Site.Name, AQS_PARAMETER_DESC, COUNTY:SITE_LONGITUDE)
EPAair2019.selected<- select(EPAair2019, Date, DAILY_AQI_VALUE, Site.Name, AQS_PARAMETER_DESC, COUNTY:SITE_LONGITUDE)
EPAair.PM25.2018.selected<- select(EPAair.PM25.2018, Date, DAILY_AQI_VALUE, Site.Name, AQS_PARAMETER_DESC, COUNTY:SITE_LONGITUDE)
EPAair.PM25.2019.selected<- select(EPAair.PM25.2019, Date, DAILY_AQI_VALUE, Site.Name, AQS_PARAMETER_DESC, COUNTY:SITE_LONGITUDE)
#5
...
```{r}
#7
EPAair_2018_Processed<- read.csv("./Data/Processed/EPAair_03_NC2018_processed.csv")
EPAair_2019_Processed<- read.csv("./Data/Processed/EPAair_03_NC2019_processed.csv")
...
```{r}
#12(a,b)
EPAair_Processed<- read.csv("./Data/Processed/EPAair_O3_PM25_NC2122_Processed.csv")
