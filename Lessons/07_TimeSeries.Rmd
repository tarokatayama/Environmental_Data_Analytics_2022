...
#Read Eno river data
EnoDischarge <- read.csv("./Data/Processed/USGS_Site02085000_Flow_Processed.csv",stringsAsFactors = TRUE)
...
#self correlation between same data set. Lagged observation of same variable
