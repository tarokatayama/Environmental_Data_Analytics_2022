...
```{r}
hi_temp<- c(49, 57, 40, 41, 44, 37, 41, 51, 52, 52)

low_temp<- c(30, 30, 18, 26, 26, 18, 26, 26, 28,40)
...
```{r}
celsius_hi<- ((hi_temp-32)*(5/9))
celsius_hi
celsius_low<- ((low_temp-32)*(5/9))
celsius_low
```
...
```{r}
weather_durham<- data.frame(hi_temp,low_temp,celsius_hi,celsius_low)
weather_durham
names(weather_durham)<- c("farenheit hi", "farenheit low", "celsius hi", "celsius low")
weather_durham
```
...
```{r}
summary(weather_durham)
sd(weather_durham$`farenheit hi`)
```
