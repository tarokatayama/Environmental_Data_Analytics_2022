...
Paul.naomit <- PeterPaul.chem.nutrients %>%
  ...
  na.omit()
#could be removed if AIC is lower than starting point, should be kept if variable leads to higher AIC. 
#AIC removes variables one at a time
